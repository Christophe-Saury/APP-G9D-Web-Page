			...
			<div id="div3" class="moydiv">
				...
				<div class="tableau">	
                    ...
                    if (mysqli_num_rows($result)>0) {
                        ...
                        echo"<table>";
                        echo "<tr id='tr2'> <td> <form action = 'Gestion_des_profils_admin_Christophe.php' method='post'> <button name='BoutonProfil'id ='userimage'><img src='LeoMelki.jpg' width=30 height=30p /></button></form></td> <td>".$row['Prenom'].",".$row['Nom'].",</td> <td>".$row['Role'].",</td> <td>".$row['age'].",</td> <td>".$row['ancienneté']."</td></tr>\n";
                        echo "</table>";
                    }
