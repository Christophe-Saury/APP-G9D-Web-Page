...
<html>
	<head>
		<title> Gestion_des profils_admin/Pierre.php </title>
		<meta charset="utf-8">
	...
	<body>
		...
		<div id="div1" class="grosdiv">
			...
			<img src="PierreTomei.jpg" width=100 height=100 id="grandimageprofil"/>
                <?php
                $id_user;
			...
			<div id="div3" class="moydiv">
				...
				<div id="div4" class="divrecherche">
				    <form action="Gestion_des_profils_admin_Christophe.php" method="post" id="form1">
				...
				<div class="tableau">	
                    ...
                    if (mysqli_num_rows($result)>0) {
                        ...
                        echo"<table>";
                        echo "<tr id='tr2'> <td> <form action = 'Gestion_des_profils_admin_Pierre.php' method='post'> <button name='BoutonProfil'id ='userimage'><img src='ProfilParticulier.JPEG' width=30 height=30p /></button></form></td> <td>".$row['Prenom'].",".$row['Nom'].",</td> <td>".$row['Role'].",</td> <td>".$row['age'].",</td> <td>".$row['ancienneté']."</td></tr>\n";
                        echo "</table>";
                    }
