				...
				<form action="../../Model/ajouter_faq.php" method="post" id="addq">
				    ...
				    <table class="updatefaq">
					    ...
					    <tr>  
						    ...
						    <td> <textarea name="Contenu_question" style="width:400px;height:200px;"> Question ici </textarea> </td>
					    </tr>
						...
						<tr>
							...
							<td> <textarea name="Contenu_reponse" style="width:400px;height:200px;"> Reponse ici </textarea> </td>
