...
include ('../pages_ticketing/modele/requetes_generiques.php');
...
include ('../pages_ticketing/vue/header.php');
include ('../pages_ticketing/vue/' . $vue . '.php');
include ('../pages_ticketing/vue/footer.php');
?>