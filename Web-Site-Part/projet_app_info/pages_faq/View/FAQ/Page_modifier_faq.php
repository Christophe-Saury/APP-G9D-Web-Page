...
<html>
    ...
    <body>
        ...
        <tr>  <!-- Deuxième ligne du texte -->
            ...
            <td> <textarea id ="newquest" name="Contenu_question" style="width:400px;height:200px;" required> <?= $row['Questions'] ?> </textarea> </td>
        </tr>
        ...
        <td> <textarea  id="newrep" name="Contenu_reponse" style="width:400px;height:200px;" required> <?= $row['Reponses'] ?> </textarea> </td>
