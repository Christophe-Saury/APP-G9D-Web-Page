    ...
    <div class="div_container">
            ...
            <div class="Answer_Container">
                ...
                <div class="Answer_Column">
                    ...
                    <div class = "Answer_Box">
                        <Input id='id3' type='Checkbox' Name ="choice" value ="<?php echo  $choices_text_arr[1]; ?>" onclick="chbx(this)">
          ...
          <!--  <input type="submit" value="Submit" />
            ...
            <div class="Button_Container">
                ...
                <div class="Button_Column">
                    <button class="Big_button" type="button" onclick="window.location.href =  'question.php?n=<?php echo($number-1); ?>'" > Question Précédente </button>
