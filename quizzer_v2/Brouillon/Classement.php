<<<<<<<< HEAD:pages_qcm/Page Classement.html
<!DOCTYPE html>
<html>
    <head>
        <title>Score</title>
        <link rel="stylesheet" href="CSS Page Classement.css"/>
    </head>
    <body>
            ...
            <div class="ScoreBoard_Row">
                ...
                <div class="ScoreBoard_Column1">
                    ...
                    <div class="ScoreBoardNameBox">
                        <label class="ScoreBoardName">Name2</label>
                    </div>
                ...
                <div class="ScoreBoard_Column2">
                    ...
                    <div class="ScoreBoardNameBox">
                        <label class="ScoreBoardName">Name1</label>
                    </div>
                    <div class="ScoreBoardNumber">
                ...
                <div class="ScoreBoard_Column3">
                    ...
                    <div class="ScoreBoardNameBox">
                        <label class="ScoreBoardName">Name3</label>
                    </div>
                    <div class="ScoreBoardNumber">
                ...
                <div class="MyPlacement_Column">
                    ...
                    <div class="MyPlacement_Row">
                            ...
                            <div class="NumberScoreBox">
                                <label class = "NumberScore_text"> 06 </label>
                            </div>
                            <div>
                                <img class="UserPhoto" src="">
                            </div>
                            <div class="NameScoreBox">
                                <label class ="NameScore">Jean Dupont</label>
                            </div>
...
>>>>>>>> 09bfbd13b9aaf4b17698ed8d8bfee2d200151a3c:quizzer_v2/Brouillon/Classement.php
